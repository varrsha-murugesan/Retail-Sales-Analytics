...
app = FastAPI(title="Discount Optimization API")
...
# Features + Targets
FEATURES = ["product", "category", "region", "base_price", "discount_pct"]
X = df[FEATURES]
...
num_cols = ["base_price", "discount_pct"]
...
@app.get("/")
def home():
    return {"message": "Discount Optimization API is running 🚀"}
